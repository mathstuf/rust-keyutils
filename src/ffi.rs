...
pub const KEY_POS_VIEW: key_perm_t = 0x01000000;

// possessor can read key payload / view keyring
pub const KEY_POS_READ: key_perm_t = 0x02000000;

// possessor can update key payload / add link to keyring
pub const KEY_POS_WRITE: key_perm_t = 0x04000000;

// possessor can find a key in search / search a keyring
pub const KEY_POS_SEARCH: key_perm_t = 0x08000000;

// possessor can create a link to a key/keyring
pub const KEY_POS_LINK: key_perm_t = 0x10000000;

// possessor can set key attributes
pub const KEY_POS_SETATTR: key_perm_t = 0x20000000;
...
// group permissions...
pub const KEY_GRP_VIEW: key_perm_t = 0x00000100;
...
pub const KEY_OTH_VIEW: key_perm_t = 0x00000001;
...
#[link(name = "keyutils")]
extern "C" {
    pub fn add_key(type_: *const libc::c_char,
                   description: *const libc::c_char,
                   payload: *const libc::c_void,
                   plen: libc::size_t,
                   keyring: key_serial_t)
                   -> key_serial_t;
    pub fn request_key(type_: *const libc::c_char,
                       description: *const libc::c_char,
                       callout_info: *const libc::c_char,
                       keyring: key_serial_t)
                       -> key_serial_t;

    pub fn keyctl_get_keyring_ID(id: key_serial_t, create: libc::c_int) -> key_serial_t;
    pub fn keyctl_join_session_keyring(name: *const libc::c_char) -> key_serial_t;
    pub fn keyctl_update(id: key_serial_t,
                         payload: *const libc::c_void,
                         plen: libc::size_t)
                         -> libc::c_long;
    pub fn keyctl_revoke(id: key_serial_t) -> libc::c_long;
    pub fn keyctl_chown(id: key_serial_t, uid: libc::uid_t, gid: libc::gid_t) -> libc::c_long;
    pub fn keyctl_setperm(id: key_serial_t, perm: key_perm_t) -> libc::c_long;
    pub fn keyctl_describe(id: key_serial_t,
                           buffer: *mut libc::c_char,
                           buflen: libc::size_t)
                           -> libc::c_long;
    pub fn keyctl_clear(ringid: key_serial_t) -> libc::c_long;
    pub fn keyctl_link(id: key_serial_t, ringid: key_serial_t) -> libc::c_long;
    pub fn keyctl_unlink(id: key_serial_t, ringid: key_serial_t) -> libc::c_long;
    pub fn keyctl_search(ringid: key_serial_t,
                         type_: *const libc::c_char,
                         description: *const libc::c_char,
                         destringid: key_serial_t)
                         -> libc::c_long;
    pub fn keyctl_read(id: key_serial_t,
                       buffer: *mut libc::c_char,
                       buflen: libc::size_t)
                       -> libc::c_long;
    pub fn keyctl_instantiate(id: key_serial_t,
                              payload: *const libc::c_void,
                              plen: libc::size_t,
                              ringid: key_serial_t)
                              -> libc::c_long;
    pub fn keyctl_negate(id: key_serial_t,
                         timeout: libc::c_uint,
                         ringid: key_serial_t)
                         -> libc::c_long;
    pub fn keyctl_set_reqkey_keyring(reqkey_defl: libc::c_int) -> libc::c_long;
    pub fn keyctl_set_timeout(key: key_serial_t, timeout: libc::c_uint) -> libc::c_long;
    pub fn keyctl_assume_authority(key: key_serial_t) -> libc::c_long;
    pub fn keyctl_get_security(key: key_serial_t,
                               buffer: *mut libc::c_char,
                               buflen: libc::size_t)
                               -> libc::c_long;
    // pub fn keyctl_session_to_parent()
    //    -> libc::c_long;
    pub fn keyctl_reject(id: key_serial_t,
                         timeout: libc::c_uint,
                         error: libc::c_uint,
                         ringid: key_serial_t)
                         -> libc::c_long;
    pub fn keyctl_invalidate(id: key_serial_t) -> libc::c_long;
    pub fn keyctl_get_persistent(uid: libc::uid_t, id: key_serial_t) -> libc::c_long;
}
